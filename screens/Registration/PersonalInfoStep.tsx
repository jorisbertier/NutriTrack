...
const PersonalInfoStep = ({ name, setName, firstname, setFirstname, dateOfBirthFormatted, showDatePicker, setShowDatePicker, onChangeDate, nameError, firstnameError, DateTimePicker, dateOfBirth, fiveYearsAgo }: PersonalInfoStepProps) => {
