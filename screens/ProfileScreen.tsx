...
const ProfileScreen = () => {
  ...
  return (
    <ScrollView contentContainerStyle={[styles.container, {backgroundColor: colors.whiteMode}]}>
      ...
      {isLoading ? <Image source={require('@/assets/images/profil/avatar.png')} style={styles.profileImage} />  : <Skeleton colorMode={colorMode} height={120} width={120} radius={'round'}/> }
